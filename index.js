...
//localStorage.getItem give null value when key is not found so when we match it with false then if condition is true and when we make key value false the false!=false gives false so, if condition is always false
